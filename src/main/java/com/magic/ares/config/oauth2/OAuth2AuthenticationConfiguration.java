package com.magic.ares.config.oauth2;

import com.magic.ares.security.oauth2.CookieTokenExtractor;
import com.magic.ares.security.oauth2.OAuth2AuthenticationService;
import com.magic.ares.security.oauth2.OAuth2CookieHelper;
import com.magic.ares.security.oauth2.OAuth2TokenEndpointClient;
import com.magic.ares.web.filter.RefreshTokenFilterConfigurer;
