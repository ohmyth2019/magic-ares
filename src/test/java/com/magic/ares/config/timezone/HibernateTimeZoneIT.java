package com.magic.ares.config.timezone;

import com.magic.ares.AresApp;
import com.magic.ares.config.SecurityBeanOverrideConfiguration;
import com.magic.ares.repository.timezone.DateTimeWrapper;
import com.magic.ares.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, AresApp.class})
